# -*- coding: utf-8 -*-
"""dev_check.py — FastInsights 一键质量门禁（测试/调试/检查/验证）
...
EMAIL = "admin@fastinsights.example"
PASSWORD = "FastInsights2026$"
ROUTES = ['/dashboards', '/queries', '/build', '/sql', '/sources', '/ai', '/guide']
