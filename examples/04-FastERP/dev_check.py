# -*- coding: utf-8 -*-
"""dev_check.py — FastERP 一键质量门禁（测试/调试/检查/验证）
...
EMAIL = "admin@fasterp.example"
PASSWORD = "FastERP2026$"
ROUTES = ['/orders', '/invoices', '/items', '/customers', '/suppliers', '/purchase', '/accounting', '/ai', '/guide']
