# -*- coding: utf-8 -*-
"""desktop.py — FastHelpdesk 桌面入口（pywebview + uvicorn）
...
要点：
  ...
  - 通过 FASTHELPDESK_DB / FASTSME_AUTH_DB 把两个 SQLite 库重定向到可写目录
...
登录（两套并存）：
  Sign-in 弹窗 / 原生登录页 : admin@fasthelpdesk.example / FastHelpdesk2026$
"""
import os, sys, socket, threading, signal
from pathlib import Path

APP_TITLE = "FastHelpdesk"
ENV_PREFIX = "FASTHELPDESK"
DB_FILENAME = "fasthelpdesk.sqlite"
DEFAULT_PORT = 5023
